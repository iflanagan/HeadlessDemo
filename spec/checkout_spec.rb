...
describe "Checkout" do
  it 'adds an item to the cart' do
    @browser.goto "http://saucedemo.com/inventory.html"
    ...
    @browser.goto "http://saucedemo.com/cart.html"
  ...
  it 'goes to the checkout page' do
    ...
    expect(@browser.url).to eq 'http://saucedemo.com/checkout-step-one.html'
  end
end
